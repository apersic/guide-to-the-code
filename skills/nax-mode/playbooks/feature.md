...
6. Sequence the work into verifiable units. Verify each unit before the next (the **sequence-verifiable-units** principle skill). Do not commit or open a PR unless the user asked.
7. If the design is contested, `interrogate` before shipping.
8. Present the work. If the user asked to commit or open a PR, run **Opening a PR**. Otherwise stop here.
