...
The **nax-mode** skill shows the shape. Read it for granularity. Don't copy its content; the user's rules are not the same as nax-mode's.
...
- The **nax-mode** skill: example of the output shape.
